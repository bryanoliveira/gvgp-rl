...
parser.add_argument('--wrapper', type=str, default='ale', help='Game emulator wrapper framework')
parser.add_argument('--game', type=str, default='gvgai-cec1-lvl0-v0', help='ATARI game')  # default='space_invaders' gvgai-cec1-lvl0-v0
parser.add_argument('--T-max', type=int, default=int(50e5), metavar='STEPS',  # 50e6
...
if args.wrapper == 'ale':
    ...
    print('Please choose a wrapper from [ale, gvgai, gym]')
...
print('Action Space Length: ' + str(action_space))
...
print('Creating validation memory...')
...
while T < args.evaluation_size:
    ...
    state = next_state
    T += 1
print('Created validation memory.')
